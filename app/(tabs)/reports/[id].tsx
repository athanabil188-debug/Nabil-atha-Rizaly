...
export default function ReportDetailScreen() {
  ...
  const fetchDetail = async () => {
    ...
    try {
      // Asumsi skema:
      // - tabel: reports (kolom: id, judul, isi, lokasi, status, created_at, user_id)
      ...
      // Asumsi skema komentar:
      // - tabel: comments (kolom: id, report_id, isi, created_at, user_id)
  ...
  const submitComment = async () => {
    ...
    try {
      ...
      // Debug sederhana biar tahu insert benar-benar jalan
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={[styles.commentInputWrap, { paddingBottom: insets.bottom }]}>
        <TextInput
